...
def save_to_file(names, output_file, version, version_path, id_type):
    """Save IDs to a Python file"""
    with open(output_file, "w", encoding="utf-8") as f:
        f.write(f"# {id_type} ID list of Minecraft version {version}\n")
        f.write(
            f"#   auto-generated by get_{id_type.lower()}_id.py as {id_type.lower()}_{version_path}.py\n\n"
        )
        for name in names:
